...
namespace Lista_de_Tarefas.Controllers
{
    public class TarefasController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nome,Descricao,Inicio,Fim,Importancia")] Tarefa tarefa)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nome,Descricao,Inicio,Fim,Importancia")] Tarefa tarefa)
        {
            if (id != tarefa.Id)
            {
                return NotFound();
